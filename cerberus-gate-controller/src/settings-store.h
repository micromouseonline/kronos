...
//  net/wifi-credentials.h and display/touch-calibration.h. Currently just
//  the two Settings-screen switches (race/race-serial-telemetry.h's
...
inline void settings_load(bool &watchdog_enabled, bool &wifi_stats_enabled) {
  Preferences prefs;

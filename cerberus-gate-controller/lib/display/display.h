...
#elif defined(BOARD_CYD2USB_DIYMALLS_ST7789)  // Sunton CYD2USB, DIYMALLS variant with ST7789 panel driver (ESP32-2432S028R family) -- confirmed against a working TFT_eSPI reference config
...
#elif defined(BOARD_JC2432W328C)  // Guition/JC JC2432W328C -- ST7789 panel (SPI) + CST820 touch (I2C), both cross-confirmed against working reference code for this exact board
